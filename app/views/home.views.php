    ...
    <header>
        ...
        <nav>
            ...
            <div class="debut-header">
                ...
                <a href="#">CONTACT</a>
                <?php
                # je verifie que une valeur est associee a la cle "utilisateur" dans l'array $_SESSION

                if (isset($_SESSION['utilisateur'])) { # ==> renvoie True si l'utilisateur est connecte
                ?>
                    <form method="post">
